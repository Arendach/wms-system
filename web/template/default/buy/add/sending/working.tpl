...
<div class="type_block">
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <select id="delivery" class="form-control field">
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <input autocomplete="off" id="date_delivery" type="date" class="form-control field"
                   value="<?= date('Y-m-d') ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <input autocomplete="off" placeholder="Введіть 3 символи" id="coupon" class="form-control field">
        </div>
    </div>
