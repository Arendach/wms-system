...
<table class="table table-bordered orders-table">
    ...
    <tr class="tr_search">
        ...
        <td>
            <input class="search form-control" id="with_to" value="<?= get('with_to') ?>">
        </td>

        <td>
            <select id="region" class="form-control search">
                <option value=""></option>
                <?php foreach (Settings::regions() as $r) { ?>
                    <option <?= $r != get('region') ?: 'selected' ?> value="<?= $r ?>"><?= $r ?></option>
                <?php } ?>
            </select>
        </td>
        <td>
